...
import 'manufacturing_complaint_controller.dart';

class ManufacturingComplaint extends StatefulWidget {
  const ManufacturingComplaint({super.key});

  @override
  State<ManufacturingComplaint> createState() => _ManufacturingComplaintState();
}

class _ManufacturingComplaintState extends State<ManufacturingComplaint> {
  final controller = Get.put(ManufacturingComplaintController());

  @override
  void dispose() {
    Get.delete<ManufacturingComplaintController>();
    super.dispose();
  }
